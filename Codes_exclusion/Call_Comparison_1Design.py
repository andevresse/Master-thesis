...
v1 = compare_costs(r'Ref\cost_breakdown.txt',r'Results\output_114\\cost_breakdown.txt') # Open and close the file
v2 = compare_costs(r'Ref\cost_breakdown.txt',r'Results\output_70\\cost_breakdown.txt') # Open and close the file
...
plt.bar(np.arange(0,bins,1)-0.15,cs1-co1,width=0.3,label = 'R = 0.9')
plt.bar(np.arange(0,bins,1)+0.15,cs2-co2,width=0.3,label = 'R = 0.6')
